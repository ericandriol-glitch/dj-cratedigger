...
export default function GigScreen({ nav }) {
      ...
      .then((data) => {
        const list = (data.tracks || []).map((t) => {
          ...
          return {
            ...
            key: t.key || "",
            e,
            cue: true, // no cue data from API, default true
            z,
          };
        });
        setTracks(list);
  ...
  const mockTracks = [
    { a: "Tale Of Us", t: "Astral (Extended)", bpm: 126, key: "8A", e: 0.92, cue: true, z: "peak" },
    { a: "Mind Against", t: "Atlant", bpm: 128, key: "11B", e: 0.88, cue: true, z: "peak" },
    { a: "Stephan Bodzin", t: "Zulu", bpm: 124, key: "5A", e: 0.74, cue: true, z: "build" },
    { a: "Dixon", t: "Transmoderna", bpm: 122, key: "2A", e: 0.62, cue: false, z: "groove" },
    { a: "Ame", t: "Rej (DJ Koze Remix)", bpm: 120, key: "7A", e: 0.45, cue: true, z: "warm" },
    { a: "Solomun", t: "After Rain", bpm: 118, key: "8A", e: 0.35, cue: false, z: "warm" },
  ];
